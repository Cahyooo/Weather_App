import {
  ...
  getWeather,
  getWeatherHourly,
} from "./WeatherInformation.service";
  ...
  return (
    <main>
      {weatherInfo === "" || location === "" || dataHourly === "" ? (
        geo.length === 0 ? (
          <div className="text-center align-middle text-white text-3xl mt-[45vh] px-2">
            <p className="max-[700px]:text-2xl max-[500px]:text-xl">City Not Found, Try Search For Another City</p>
            <form
              method=""
              action=""
            ...
            >
              <button
                type="submit"
                className="bg-[#1F293B] h-10 w-14 rounded-lg"
              >
                <svg
                  width="64px"
                  height="64px"
                  ...
                  stroke="#ffffff"
                  className="w-6 h-6 max-[500px]:w-5 max-[500px]:h-5 max-[500px]:-translate-y-[10px] max-[500px]:translate-x-5 absolute -translate-y-3 translate-x-3"
                >
              ...
              <input
                type="text"
                className="bg-[#384563] h-10 w-[30vw] max-[1100px]:w-[45vw] max-[700px]:w-[55vw] max-[500px]:w-[60vw] max-[400px]:w-[70vw] focus:outline-none text-sm rounded-lg pl-3"
        ...
        <article className="bg-[#0F172A] w-auto pb-10 rounded-xl md:mx-10 my-5 text-white px-4 lg:px-7 xl:px-14">
          ...
          <TodayOverview
            weatherInfo={dataHourly}
            weatherInfoDetail={weatherInfo}
